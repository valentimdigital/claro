        ...
        pageTypes: [
            {
                ...
                isMatch: () => window.location.pathname === "/",
                contentZones: [
                    { name: "event_register_mcrminha-claro-residencial_banner", selector: "[data-v-3021d3ce]" + ".full-width" },
                    { name: "carousel_mcrminha-claro-residencial_banner", selector: ".digitalServices__card-Image" },
                ],
                listeners: [
